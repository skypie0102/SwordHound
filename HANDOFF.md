...
3. Keep completeness independent from sanitization and preserve all Phase-1 dispositions plus the 42 completeness-only additions found so far.
4. Keep manuscript remediation deferred to Phase 4; Phase 2 remains discovery/evidence only.
5. Preserve documented source gaps, shifted witnesses, combined raws, canonical terminology decisions, and safety-limited exceptions without prematurely declaring Phase-3 boundary clearance.
6. Keep EPUB assembly blocked.

The next agent should resume with **Phase 2 Chapter 253**.
