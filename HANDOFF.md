...
**Current audit stage:** Phase 4 ACTIVE — 33 affected families complete through Mixed Bath (203–205); 91/273 remediation chapters complete; next affected family Festival Night (206–215)
...
- Phase-4 manuscript edits: **93**
- Last completed affected family: **Mixed Bath (203–205)**
- Next affected family: **Festival Night (206–215)**
- Earliest remaining remediation target: **206**
- EPUB assembly remains blocked

## Exact next actions

1. Continue **Phase 4** with **Festival Night (206–215)**.
2. Reread the complete family against Chinese-primary sources and shifted English witnesses.
3. Repair all queued ordinary sanitization/completeness defects while preserving documented safety limits.
4. Re-run both primary gates and refresh chapter QA, family QA, provenance, acceptance, tracker, ledger, and live docs.
