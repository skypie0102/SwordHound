...
Target 82 → E81 is verified by: successful completion of purification trials → three drops of Plany de la Verge / Saintess's Tears → first-Saintess lament/prayer → guarded procession → Old/New Testament faction tension → Humbert meeting Dolores → plague-source report → children/ghost testimony → vial + Leviathan dagger + Bourgeois button → Humbert's holy-war reaction → order to arrest Hound of the Night → Dolores protests → remembered self-doubt/comfort conversation → Humbert goes to arrest him → empty room/broken window → one Saintess's Tear missing → Dolores realizes Vikir's purpose and fears she will not see him again.
...
- PASS — the Chinese pet-name `小妖精` is rendered nonsexually as **“little sprite.”** The recovered/raw English gloss `Nymphet`, which sexualizes a sixteen-year-old, is not reproduced.
- PASS — Dolores's investigative skill and academy detective-club background remain.
- PASS — evidence found near the well:
