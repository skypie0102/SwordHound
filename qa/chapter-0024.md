# Chapter 24 QA — Camus Morgue (5)

**Chapter-level status:** PASS  
**Family acceptance:** contingent on `qa/families/camus-morgue-0020-0025.md`
...
Target 24 → recovered English 24 is **verified** by the spillover explosion, Camus's burned outer clothing and Vikir giving her his training cloak, Vikir's bleeding forehead ending the match, Hugo/Vikir discussion of the ruby mine, Baskerville frontier strategy, Adolf's marriage proposal, Osiris's prior engagement, Camus looking toward Vikir, Adolf's Van-line objection, and the endpoint where Vikir says he stopped listening to Adolf.
...
- **Explicitness/tone:** PASS. Baskerville doctrine of killing and pursuing displaced monsters/barbarians to prevent retaliation is preserved without sanitization.
- **Natural English:** PASS.
- **Boundary:** PASS. Chapter ends on Vikir's `I stopped listening` reply; Adolf's personal test remains wholly in Chapter 25.
...
6. Keeps the source's harsh pursuit/extermination logic intact.
7. Corrects Camus age 8 + Osiris age 20 to a **12-year** age difference; recovered English incorrectly states seventeen.
8. Preserves Hugo's statement that Osiris already has a prenatal engagement.
9. Preserves Camus's stated preference for someone her age or younger and her look toward Vikir without importing later romantic outcomes.
10. Restores Hugo's defense of talent emerging from Van as well as Le and Vikir's unconditional answer that he will obey Hugo's order.
11. Preserves the endpoint joke: Adolf says his warning is not meant for Vikir to hear; Vikir therefore stops listening.
