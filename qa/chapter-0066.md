...
Target 66 → E65 is verified by complete sequence: Sir Smuggler returns to mercenary camp → attack vote → three-cigarette/match setup → Ballak arrows annihilate lit/noisy targets → Vikir orders survivors left alive to expose rear base → second mercenary camp uses shields/magic → oil-barrel arrow attack burns supplies → Vikir confronts Sir Smuggler → Underdog exploration permit / identity recognition / revocation → Aiyen kills Smuggler → Ballak withdraws → fire/noise draws Madam Eight-Legs → remaining camp falls silent.
...
- PASS — Sir Smuggler produces a genuine-looking Underdog City exploration permit bearing deputy-magistrate/Baskerville authority.
- PASS — Vikir wipes away soot, is recognized, and revokes/crosses out the permit before burning it; the draft does not invent a detailed legal mechanism beyond the source.
- PASS — Aiyen kills Sir Smuggler with repeated arrows after Vikir's confrontation.
- PASS — the fire/noise was deliberately useful for attracting **Madam Eight-Legs**; Ballak flees before the monster reaches the surviving camp.
- PASS — chapter endpoint is total silence behind Aiyen/Vikir/Bakira as the Madam's attack finishes.
