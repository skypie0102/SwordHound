# Chapter 129 QA — Admission to the Academy (4)

**Status:** PASS  
**Family acceptance:** contingent on `qa/families/admission-academy-0126-0129.md`
...
## Checks
- PASS — warehouse/orphan-transfer setup and the guards' Quovadis-orphanage rumor are retained without treating mercenary gossip as verified fact.
- PASS — Ron Hubert Bartison is a northern mercenary and Sword Graduator; the Night Hound overwhelms him immediately.
- PASS — Bartison's four-years-earlier demon-pact crime is distinguished from later Human Alliance betrayal that Vikir remembers from the previous timeline and Bartison has **not yet committed**.
- PASS — postmortem face decay and soul-level rotten odor are preserved as signatures associated with demon pacts.
- PASS — Vikir treats the unusually rapid facial decay as a clue requiring investigation rather than identifying a specific remaining Corpse without evidence.
- PASS — findings are sent to Cindywendy through an owl messenger.
- PASS — Vikir uses strong rum to clean his cloak, establishing the odor Bianca later detects.
- PASS — the first night removes twenty-nine blacklist targets but yields almost no direct clue to the remaining Ten Corpses.
- PASS — Vikir returns after midnight and decides to appear briefly at orientation for an alibi and because he is somewhat concerned about Pigi.
- PASS — Bianca Fo Usher rejects a second-year student's rooftop confession; Vikir observes briefly without inserting himself.
