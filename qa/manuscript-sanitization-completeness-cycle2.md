...
- reviewed: **362 / 500** targets;
- PASS: **53**;
- FAIL: **2**;
- EXCEPTION-DOCUMENTED: **307**;
- families reviewed: **86 / 118**;
- family PASS: **14**;
- family FAIL: **2**;
- family EXCEPTION-DOCUMENTED: **70**;
- genuine source-exception rows added during Phase 3: **295**;
- manuscript edits during Phase 3: **0**;
- open structural FAILs: **273, 283**;
- latest checkpoint: `qa/cycle2-phase3-checkpoint-0362.md`;
- next family: **Ghost Castle of the Ultra-Deep Sea (363–365)**;
...
1. Continue Phase 3 from **Ghost Castle of the Ultra-Deep Sea (363–365)** and proceed in contiguous title-family order.
