...
Target 65 → E64 is verified by complete sequence: “trade is void” continuation → merchants panic over Vikir's Imperial → perishability leverage → fair-market repricing → defective heated seed reveal → narcotic glass/trinket reveal → Vikir cites Underdog law / his own Special Law → merchants expelled → Ahun gives Vikir boar meat → **Aheul** revealed as Ahun's younger sister and drug victim → chieftain summons warriors because merchants plan a night attack.

## Fidelity / terminology

- PASS — Vikir distinguishes Ballak's durable trade goods from merchants' perishable grain/vegetables and uses that asymmetry as bargaining leverage.
...
- PASS — **Aheul** follows indexed Fandom canonical spelling and enters by name here as **Ahun's younger sister**.
- PASS — Aheul's weakness is connected to the drug-laced goods at this point; no later Red Death material is imported.
- PASS — Ahun's smoked-boar gift and awkward thanks are retained as gratitude for helping his sister, not rewritten as sudden friendship.
- PASS — chapter ends when Ballak receives warning that the expelled merchants are preparing a night attack.
