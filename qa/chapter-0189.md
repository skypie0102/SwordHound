...
## Checks
- PASS — Vikir avoids using Cindywendy's money because money trails can expose covert agents and House Bourgeois is being reserved as a later strategic resource.
- PASS — aligned witness forms **Mr. Pringles** and **Languid Noon, Moustache** are retained for the café owner/business.
- PASS — owner normally hires women only; Sinclaire's reveal of Vikir's face produces escalating offers up to double wage.
- PASS — Vikir rejects the job because time cost conflicts with demon hunting and the income is inefficient for his tuition needs.
- PASS — Vikir plans monster hunting during the post-midterm break as the higher-income alternative.
- PASS — café-uniform / cross-dressing joke remains source comedy without changing Vikir's decision.
- PASS — new copycat article concerns Varangian students visiting the Imperial Capital; broken vodka bottle is the only physical evidence stated in the article.
- PASS — Dolores immediately identifies the incident as copycat work and calls the imitator the real villain.
- PASS — one copycat has become less active while the other remains active; no identity is assigned yet.
