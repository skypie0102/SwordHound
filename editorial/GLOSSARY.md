...
- **Raspane Morgue** — accepted where referenced; current Morgue Clan head/matriarch, Camus's mother, Adolf's sister.
...
- **Fireball / Ice Sphere / Thunder Ring / Mud Wall** — accepted Chapter 23 spell names.
- **Superspeed Regeneration — Troll (C+)** — from Chapter 20 onward, Beelzebub Slot 3 replaces Brown Rat Rapid Regeneration with this ability. Do not backfill the slot replacement into Chapter 19.
- **Camus–Osiris proposed engagement:** Camus is 8 and Osiris 20, therefore **12 years** apart. Recovered-English 17-year wording is rejected. Chinese also contains a separate awkward Hugo `40 / 57` rhetorical jab; do not use that to redefine the engagement gap.
- Chapter 24's accidental clothing damage involving the two eight-year-old characters is an event detail, not terminology; render it neutrally/non-sexually without added body description.
...
| **Hugo Le Baskerville / Marquis** | Accepted. Chinese Ch. 1 uses `伯爵` (“Count”) once; canonical **Marquis** retained with conflict documented. |
| **Baskerville Clan / Iron-Blooded Sword Clan** | Accepted. Contextual `Baskervilles` / `family` remains natural. |
| **Morgue Clan** | Accepted from Ch. 6 onward where present. |
...
| **Camus Morgue / Ironblood Empress** | Accepted. Use future title only when Chinese itself reveals future Camus. |
...
| **Low / Mid / High Sword Expert** | Accepted. Gas-like aura stage; Ch. 20 normal age formula: ~15 / 18 / 20. |
| **Low / Mid / High Sword Graduator** | Accepted. Dense/liquid aura stage; Ch. 20 normal age formula: ~30 / 35 / 40. |
...
| **Le Rouge et Le Noir Mountain** | Accepted. Used for survival-exam and monster/ridge geography. |
...
|---|---|
| **Brown Rat Norvegicus** | F-rank source of **Rapid Regeneration**; Beelzebub carries this through Ch. 18. |
...
| **Rapid Regeneration** | Brown Rat ability occupying Slot 3 through Ch. 18. |
| **Superspeed Regeneration** | Troll ability; replaces Slot 3 starting in Ch. 20. |
| **Bloody Mamba** | Scoped recovered-English fallback for Ch. 3/11 snake/venom continuity; dedicated Fandom formal species entry was not established. |
...
- Ch. 16 first-life Vikir is a **one-eyed black hound**, not MTL `right-handed black dog`; library-fire timing is ~**10h50m**, not duplicated 11h50m.
- Ch. 17 advances Vikir to **Low Sword Graduator**; stable 4th Fang, unstable/emerging 5th.
- Ch. 18 isolated source age phrase is resolved against repeated age-eight chronology as a comparison to the normal age-fifteen Low Expert milestone.
