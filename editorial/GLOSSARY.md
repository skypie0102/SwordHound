...
- **Poseidon form** — approximately five-meter blue, egg-like sphere with aura-root structures.
- **Poseidon growth** — absorbs external impact and grows stronger/larger from it.
...
- **Bakira** — Aiyen's wolf/hunting companion.
- **Oxbear** — standard info window: **Danger Rating A / 5 m / Le Rouge et Le Noir Mountain, 7th Ridge**. The observed old female is an exceptional ~8 m specimen.
- **Target 57 English gap** — no clean standalone recovered-English chapter; E56 overlaps only part of the Oxbear-selection setup, while E57 begins target 58.
- **Shifted English map** — target 58→E57, 59→E58, 60→E59; E60 starts target 61.
- **Cold Valley** — descriptive rendering for the Ch.59 cold camp; keep provisional absent stronger canonical evidence.
- **Low Sword Graduator** — Aiyen's aura rank in Ch.60; never `Gradient`.
- **Beelzebub / Slot 1 Incinerate — Cerberus (A+)** — reaffirmed in Ch.60.
- Oxbear mating/exhaustion strategy and Ballak reproductive comparison are retained clinically and non-erotically.
- Target 60's “collect your seed” emergency line is a Ballak reproductive contingency joke; preserve meaning without sexual expansion.
- **The Protagonist of Hunting** — next normalized working family title for targets 61–63. Verified witnesses: 61→E60, 62→E61, 63→E62.

## Slaves of the Savage Tribe additions — Chapters 52–54

- **Slaves of the Savage Tribe** — normalized working production family title for Chinese `野蛮部落的奴隶 (1)–(3)`.
- **Thorn-Tree Punishment** — descriptive rendering of the Ballak execution in Ch.52; keep the execution explicit without promoting the phrase as an independent wiki-canonical term.
- **Tough Life** — Ch.52 recovery factor together with River Styx protection and Aiyen's noose.
- **Akwilla** — Ch.53 source-reveals Aiyen's mother / Ballak chieftain as the current **Night Fox**.
- **Corrected target-54 endpoint** — Ch.54 ends after Aiyen offers the hunt as a route toward freedom and sets departure for dawn.
- The hunting ceremony, public-urination joke, wolf riding, Ahun challenge, quiver theft, punishment, and “Did it hurt?” endpoint belong to **target Ch.55**, even though most survive physically appended inside `054.txt`.
- E54 supplies the short closing exchange missing from the Chinese splice.
...
- **Chihuahua Baskerville** — accepted; male, outsider-born administrator from Underdog City, senior City Hall official / **General Secretary**. Do not follow recovered-English gender flips.
- **Dortmeyer Street** — retained as the central commercial street named in Ch. 29; no stronger competing canonical English form currently established.
...
- **Camus Morgue** — accepted current-era name; female; age eight at introduction. Chinese Ch. 22 itself invokes future title **Ironblood Empress**; later Fandom-only spoilers remain excluded.
- **Adolf Morgue** — accepted; Camus's uncle, Raspane's brother, senior Morgue political/diplomatic figure and **Sixth-Circle** mage.
- **Raspane Morgue** — accepted; Morgue Clan head/matriarch, Camus's mother, Adolf's sister.
- **Osiris Le Baskerville** — accepted; Hugo's eldest son / **Young Patriarch**.
...
| Term | Status / scope |
|---|---|
| **Vikir Van Baskerville** | Accepted from Ch. 1 onward. |
| **Hugo Le Baskerville / Marquis** | Accepted. Chinese Ch. 1 uses `伯爵` once; canonical **Marquis** retained with conflict documented. |
| **Baskerville Clan / Iron-Blooded Sword Clan** | Accepted. Contextual `Baskervilles` / `family` remains natural. |
| **John Barrymore / Head Butler** | Accepted from Ch. 6 onward where present. |
| **Highbro / Middlebro / Lowbro Le Baskerville** | Accepted triplet names. |
...
|---|---|
| **Sword Beginner** | Accepted from Ch. 4 onward. |
| **Low / Mid / High Sword Expert** | Accepted. Gas-like aura stage. |
| **Low / Mid / High Sword Graduator** | Accepted. Dense/liquid aura stage. |
...
- **Seven Great Families / Seven Great Clans** — accepted contextually; do not import unrevealed clan details.
- **Rok Empire** — accepted where referenced.
- **Bloody Beans** — accepted Ch. 7–11.
- **Guide Dog** — accepted instructor/survival-exam role.
- **Pavlov Van Baskerville** — accepted Ch. 8 Guide Dog.
...
- Ch. 12 dungeon contains **one skeleton**, not MTL two; shadow is the real riddle solution.
- Ch. 13 rejects a large recovered-English-only Beelzebub lore/fusion block absent from Chinese.
...
- **Hellhound, Ch. 1–3:** `qa/families/hellhound-0001-0003.md`
- **The Baskerville Dog, Ch. 4–7:** `qa/families/baskerville-dog-0004-0007.md`
- **Hounds of Hell, Ch. 8–11:** `qa/families/hounds-of-hell-0008-0011.md`
- **The Gluttonous Flies, Ch. 12–13:** `qa/families/gluttonous-flies-0012-0013.md`
...
Direct Fandom page access can be intermittently blocked by robots rules. Indexed Fandom results may be used for canonical terminology when clearly documented as indexed retrieval. Do not represent a blocked direct refresh as successful access.

## Historical leads — reverify when reached

- **Aiyen / Akwilla / Ballak / Ahun**
- **Kirko** rank continuity
- **Andras / Flauros / Andrealphus / Cimeries** Corpse-number reveal sequence
- **Poseidon** later aura/root context

## Rules for adding/promoting entries
