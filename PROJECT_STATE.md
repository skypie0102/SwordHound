...
**Boundary/alignment revalidated:** 384 / 500 — 53 PASS / 2 FAIL / 329 EXCEPTION-DOCUMENTED across 94 / 118 families  
...
Phase 1 sanitization and Phase 2 direct completeness review are both complete across all **500 / 500** targets. The current structural pass has reviewed Chapters **1–384** across **94 / 118** contiguous title families and now continues with **The Rotten Dog of Nouvelle Vague (385–389)**. It rechecks title-family/chapter transitions, shared or combined Chinese raw containers, the 54/55 overlap, localized source gaps, shifted/nontrivial English witness mappings, Side Story boundaries/order, and duplicated/displaced source blocks.
...
Phase 3 is active and has structurally reviewed **384 / 500** targets across **94 / 118** families with **53 PASS / 2 FAIL / 329 EXCEPTION-DOCUMENTED**, **317 genuine new source-exception rows** after duplicate-ledger normalization, and **0 manuscript edits**. Open structural failures are Chapters **273 and 283** and remain deferred to Phase 4. Checkpoint: `qa/cycle2-phase3-checkpoint-0384.md`. Next: **The Rotten Dog of Nouvelle Vague (385–389)**.
