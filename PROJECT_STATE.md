...
- Chapter 1 has a [second-pass draft](manuscript/drafts/chapter-0001.md): 106 paragraphs retained, 89 edited, with before/after provenance and all 116 supplied Korean lines accounted for.
- Chapter 1 QA is **not accepted**: six items resolved, three open. Remaining work covers two source-conflict groups and final acceptance review. The [review record](editorial/reviews/chapter-0001.md) documents Korean/MTL comparisons, wiki terminology evidence, and explicit age harmonization.
