...
- Chapter 1 QA is **not accepted**: nine open review items, including whole-chapter bilingual/continuity review. The full supplied Korean file is now available; its name/rank inconsistencies require contextual review with MTL and wiki support.
